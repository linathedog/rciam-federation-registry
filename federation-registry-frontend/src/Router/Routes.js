...
import {
  InvitationRoute,
  InvitationNotFound,
} from "../Components/InvitationRoute.js";
    ...
    <div className="content-container">
      <Switch>
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/edit"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/notifications/broadcast"
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/notifications/outdated"
          actions={["send_notifications"]}
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/requests/:petition_id/edit"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/requests/:petition_id/edit"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/requests/:petition_id/groups/:group_id"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/groups/:group_id"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          path="/:tenant_name/requests/:petition_id/groups/:group_id/contact"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          path="/:tenant_name/services/:service_id/groups/:group_id/contact"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          path="/:tenant_name/services/:service_id/history"
        >
          <HistoryList user={props.user} />
        </ProtectedRoute>
        <ProtectedRoute
          user={props.user}
          path="/:tenant_name/services/:service_id/requests/:petition_id/history"
        >
          <HistoryRequest user={props.user} />
        </ProtectedRoute>
        <ProtectedRoute
          user={props.user}
          path="/:tenant_name/requests/:petition_id/history"
        >
          <HistoryRequest user={props.user} />
        </ProtectedRoute>
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/requests/:petition_id/review"
          admin={true}
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/requests/:petition_id/review"
          admin={true}
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <TenantRoute path="/:tenant_name/nodes/:service_id/view">
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
            </Link>
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/requests/:petition_id/view_request"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/requests/:petition_id/view_request"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/services/:service_id/requests/:petition_id"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
        ...
        <ProtectedRoute
          user={props.user}
          exact
          path="/:tenant_name/requests/:petition_id"
        >
          <div className="links">
            <Link to={"/" + tenant?.name + "/home"}>
              {props.t("link_home")}
    ...
    <Route
      ...
      render={({ location }) =>
        !(tenant && props.computedMatch.params.tenant_name === tenant.name) ? (
          ...
          <UserHandler />
        ) : cookies.federation_logoutkey &&
          user &&
          (!props.actions || authorisedActions(user.actions)) ? (
          childrenWithProps
        ) : (
          <Redirect
            to={{

...
const ServiceForm = (props) => {
  ...
  const schema = yup.object({
    ...
    protocol: yup.string().test('testProtocol', t('yup_protocol'), function (value) { return tenant.form_config.protocol.includes(value) }).required(t('yup_protocol')),
  ...
  const addOrganization = async (data) => {
    if (!data.organization_id && data.organization_name) {
          ...
          <div className="tab-panel">
            ...
            <Form noValidate onSubmit={handleSubmit}>
              ...
              <div className="form-tabs-container">
                ...
                {!tenant.form_config.more_info?.integration_environment?.hide?.includes(values.integration_environment) &&
                ...
                {!tenant.form_config.more_info?.policy_uri?.hide?.includes(values.integration_environment) &&
